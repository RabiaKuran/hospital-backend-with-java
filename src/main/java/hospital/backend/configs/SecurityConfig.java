package hospital.backend.configs;
...
import hospital.backend.business.concretes.UserDetailsManager;
import hospital.backend.security.JwtAuthenticationEntryPoint;
import hospital.backend.security.JwtAuthenticationFilter;
	 ...
	 @Bean
	    ...
	    public void configure(HttpSecurity httpSecurity) throws Exception {
    		...
    		.permitAll(); */
					...
					/*
					 * .antMatchers("/api/users/deleteuser") .hasAuthority("SUPERADMIN")
					 */
